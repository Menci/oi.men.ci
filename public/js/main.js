require([], function (){
    ...
    var loadMobile = function(){
        require(['//dn-menci.qbox.me/js/mobile.js'], function(mobile){
            mobile.init();
            isMobileInit = true;
        });
    }
    var isPCInit = false;
    var loadPC = function(){
        require(['//dn-menci.qbox.me/js/pc.js'], function(pc){
            pc.init();
            isPCInit = true;
        });
    }
    ...
    if(yiliaConfig.fancybox === true){
        require(['//dn-menci.qbox.me/fancybox/jquery.fancybox.js'], function(pc){
            var isFancy = $(".isFancy");
            if(isFancy.length != 0){
    ...
    if(yiliaConfig.animate === true){
        ...
        require(['//dn-menci.qbox.me/js/jquery.lazyload.js'], function(){
            //avatar
